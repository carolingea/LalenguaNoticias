...
class NelioFP_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( count( $fps ) > 0 ) {
			...
			echo '<p class="neliofp-none">' . __( 'No featured posts.', 'nelio-featured-posts' ) . '</p>';
		}
		$post = $ori_post;
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'template' ); ?>"><?php _e( 'Template (without the «.php» extension):', 'nelio-featured-posts' ); ?></label>
			<input
